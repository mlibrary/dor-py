...
class Logger:
    ...
    def _authenticate(self):
        ...
        payload = {"identity": self.pocket_base_username, "password": self.pocket_base_password}
        ...
        if response.status_code == 200:
            ...
            raise Exception(f"Failed to save logs: {response.status_code}, {response.text}")
    ...
    def _collection_exists(self):
        ...
        headers = {"Authorization": f"Bearer {self.impersonate_token}", "Content-Type": "application/json"}
...
# logger = Logger(collection_name = "packagerlogs")


# logger.debug("This is a debug message", packageIdentifier=uuid.UUID("00000000-0000-0000-0000-000000000001"))
# logger.info("This is an info message", packageIdentifier=uuid.UUID("00000000-0000-0000-0000-000000000001"))
# logger.warn("Warning: something went wrong", packageIdentifier=uuid.UUID("00000000-0000-0000-0000-000000000001"))
# logger.error("Error: file not found", packageIdentifier=uuid.UUID("00000000-0000-0000-0000-000000000001"))
