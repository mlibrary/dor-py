...
def test_process_basic_image_copy_copies_input_file_to_output_file(identifier, input_path, output_path):
...
def test_process_basic_image_creates_technical_metadata(identifier, input_path, output_path):
...
def test_process_basic_image_creates_service_image(identifier, input_path, output_path):
...
def test_process_basic_image_creates_service_technical_metadata(identifier, input_path, output_path):
    technical_metadata_file = output_path / identifier / "metadata" / \
...
def test_process_basic_image_creates_descriptor_file(identifier, input_path, output_path):
...
def test_process_basic_image_creates_service_event_metadata(identifier, input_path, output_path):
...
def test_process_basic_image_creates_source_event_metadata(identifier, input_path, output_path):
    event_metadata_file = output_path / identifier / "metadata" / \
