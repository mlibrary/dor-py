Feature: Inspect Bin
  ...
  I want to find an associated version using my local identifier.

  In order to confirm all pages for a monograph are preserved
  As a Collection Manager
  I want to review the contents of its version.

  Scenario: Version summary
    Given a preserved monograph with an alternate identifier of "xyzzy:00000001"
    When the Collection Manager looks up the version by "xyzzy:00000001"
    Then the Collection Manager sees the summary of the version

  Scenario: Version file sets
    Given a preserved monograph with an alternate identifier of "xyzzy:00000001"
    When the Collection Manager lists the contents of the version for "xyzzy:00000001"
